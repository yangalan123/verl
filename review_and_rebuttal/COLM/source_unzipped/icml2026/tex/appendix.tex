...
\begin{figure}[h!]
    ...
    \centering
    \includegraphics[width=\linewidth]{icml2026/figures/off-policy-problem/pg_clipfrac_Qwen2.5-Math-1.5B.pdf}
    \caption{Clip Fraction Surge}
    \label{fig: off_policy_pg_clipfrac}
  \end{subfigure}
  \begin{subfigure}[b]{0.28\textwidth}
    \centering
    \includegraphics[width=\linewidth]{icml2026/figures/off-policy-problem/grad_norm_Qwen2.5-Math-1.5B.pdf}
    \caption{Gradient Norm Surge.}
    \label{fig: off_policy_grad_norm}
  \end{subfigure}
   \begin{subfigure}[b]{0.27\textwidth}
    \centering
    \includegraphics[width=\linewidth]{icml2026/figures/off-policy-problem/best_at_16_Qwen2.5-Math-1.5B.pdf}
  ...
  \begin{subfigure}[t]{0.1\textwidth}
    \centering
    \vspace{-2.5cm}
    \includegraphics[width=\linewidth]{icml2026/figures/off-policy-problem/legend-fig3.pdf}
  \end{subfigure}
...
\begin{figure}[h!]
\centering
\includegraphics[width=\linewidth]{icml2026/figures/response-length.pdf}
