...
#SBATCH --mem 128G
#SBATCH -c 64
#SBATCH --job-name=annealed_sampling_minimal_rl_token_length_decay_freq_200
#SBATCH --output=/fsx/zhuokai/verl/slurm/annealed_sampling_minimal_rl_token_length_decay_freq_200.stdout
#SBATCH --error=/fsx/zhuokai/verl/slurm/annealed_sampling_minimal_rl_token_length_decay_freq_200.stderr
...
if [ $warmup_period -eq 0 ]; then
    experiment_name="annealed_sampling_grpo_explore_${start_temp}_stable_${end_temp}_decay_freq_${decay_freq}_${strategy}_zzk_rerun"
else
    experiment_name="annealed_sampling_grpo_explore_${start_temp}_stable_${end_temp}_decay_freq_${decay_freq}_warmup_period_${warmup_period}_${strategy}_zzk_rerun"
fi
