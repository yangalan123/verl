...
#SBATCH --mem 128G
#SBATCH -c 64
#SBATCH --job-name=ead_negexp_dapo_16k_rollout_n_16_qwen_2_5_1_5b
#SBATCH --output=/fsx/zhuokai/verl/slurm/ead_negexp_dapo_16k_rollout_n_16_qwen_2_5_1_5b.stdout
#SBATCH --error=/fsx/zhuokai/verl/slurm/ead_negexp_dapo_16k_rollout_n_16_qwen_2_5_1_5b.stderr
...
if [ $warmup_period -eq 0 ]; then
    experiment_name="ead_negexp_dapo_16k_explore_${start_temp}_stable_${end_temp}_decay_freq_${decay_freq}_${strategy}_rollout_n_${rollout_n}_lr_${lr}_${model}_zzk"
else
    experiment_name="ead_negexp_dapo_16k_explore_${start_temp}_stable_${end_temp}_decay_freq_${decay_freq}_warmup_period_${warmup_period}_${strategy}_rollout_n_${rollout_n}_lr_${lr}_${model}_zzk"
fi
...
math_train_path=$ROOT_DIR/data/dapo-math-17k.parquet
math_test_path=$ROOT_DIR/data/aime-2024.parquet
