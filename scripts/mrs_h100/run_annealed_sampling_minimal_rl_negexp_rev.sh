...
#SBATCH --mem 128G
#SBATCH -c 64
#SBATCH --job-name=annealed_sampling_negexp_rev_rollout_n_16_qwen_2_5_1_5b
#SBATCH --output=/fsx/zhuokai/verl/slurm/annealed_sampling_negexp_rev_rollout_n_16_qwen_2_5_1_5b.stdout
#SBATCH --error=/fsx/zhuokai/verl/slurm/annealed_sampling_negexp_rev_rollout_n_16_qwen_2_5_1_5b.stderr
