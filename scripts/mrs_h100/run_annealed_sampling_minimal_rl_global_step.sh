...
#SBATCH --mem 128G
#SBATCH -c 64
#SBATCH --job-name=annealed_sampling_minimal_rl_global_step
#SBATCH --output=/fsx/zhuokai/verl/slurm/annealed_sampling_minimal_rl_global_step.stdout
#SBATCH --error=/fsx/zhuokai/verl/slurm/annealed_sampling_minimal_rl_global_step.stderr
...
if [ $warmup_period -eq 0 ]; then
    experiment_name="annealed_sampling_grpo_explore_${start_temp}_stable_${end_temp}_decay_freq_${decay_freq}_${strategy}_zzk"
else
    experiment_name="annealed_sampling_grpo_explore_${start_temp}_stable_${end_temp}_decay_freq_${decay_freq}_warmup_period_${warmup_period}_${strategy}_zzk"
fi
