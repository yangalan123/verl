...
#SBATCH --mem 128G
#SBATCH -c 64
#SBATCH --job-name=annealed_sampling_minimal_rl_token_length_debug_wo_kl_div_asym_clip
#SBATCH --output=/fsx/zhuokai/verl/slurm/annealed_sampling_minimal_rl_token_length_debug_wo_kl_div_asym_clip.stdout
#SBATCH --error=/fsx/zhuokai/verl/slurm/annealed_sampling_minimal_rl_token_length_debug_wo_kl_div_asym_clip.stderr
...
save_freq=10
test_freq=10
strategy="token_length"
if [ $warmup_period -eq 0 ]; then
    experiment_name="debug_run_no_kl_div_asym_clip_grpo_explore_${start_temp}_stable_${end_temp}_decay_freq_${decay_freq}_${strategy}_zzk"
else
    experiment_name="debug_run_no_kl_div_asym_clip_grpo_explore_${start_temp}_stable_${end_temp}_decay_freq_${decay_freq}_warmup_period_${warmup_period}_${strategy}_zzk"
fi
