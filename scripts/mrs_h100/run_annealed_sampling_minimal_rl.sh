...
#SBATCH --mem 128G
#SBATCH -c 64
#SBATCH --job-name=annealed_sampling_minimal_rl
#SBATCH --output=/fsx/zhuokai/verl/slurm/annealed_sampling_minimal_rl_decay_200_start_1_2.stdout
#SBATCH --error=/fsx/zhuokai/verl/slurm/annealed_sampling_minimal_rl_decay_200_start_1_2.stderr
...
save_freq=10
test_freq=10
experiment_name="annealed_sampling_grpo_explore_${start_temp}_stable_${end_temp}_decay_freq_${decay_freq}_warmup_period_${warmup_period}_zzk"
