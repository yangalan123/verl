...
if [ $warmup_period -eq 0 ]; then
    experiment_name="debug_run_no_kl_div_asym_clip_grpo_explore_${start_temp}_stable_${end_temp}_decay_freq_${decay_freq}_${strategy}"
else
    experiment_name="debug_run_no_kl_div_asym_clip_grpo_explore_${start_temp}_stable_${end_temp}_decay_freq_${decay_freq}_warmup_period_${warmup_period}_${strategy}"
fi
